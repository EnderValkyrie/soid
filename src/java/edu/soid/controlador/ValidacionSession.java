 ...
 * @author APRENDIZ
 */
@Named(value = "validacionSession")
@SessionScoped
public class ValidacionSession implements Serializable {

    /**
     * Creates a new instance of ValidacionSession
     */
